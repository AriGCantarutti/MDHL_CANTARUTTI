...
//Método auxiliar para ejecutar el proceso de cierre de orden
    private static void ejecutarCierreOrden(GestorOrden gestor, Scanner input, PantallaOrden pantalla) {
        try {
            ...
            gestor.tomarOrdenPorNumero(nroOrden);
            input.nextLine(); // Limpiar buffer
                        
            //Ingresar observación
            String observacion = pantalla.tomarObservacion();         
            ...
            //Seleccionar motivo y comentario        
            String motivoSeleccionado = pantalla.tomarMotivoFS(listaMotivos);
            String comentario = pantalla.tomarConfirmacion();
