...
public class GestorOrden {
    ...
    public List<OrdenInspeccion> buscarOrdInspeccion() {
        ...
        for (OrdenInspeccion orden : baseDatosOrdenes) {
            if (orden.esRealizada() && orden.getEmpleadoResponsable().equals(empleadoLogueado)) {
    ...
    public void tomarOrdenPorNumero(int numeroOrden) {     
        ...
        if (!ordenEncontrada.esRealizada()) {
    ...
    public void tomarObservacion(String observacion) {
        ...
        pantalla.mostrarMotivos(motivosFS);
    }
    ...
    public void tomarConfirmacion(boolean confirmado) {
        if (confirmado) {
            ...
            if (esValido) {
                ...
                // Cerrar la orden
                ordenSeleccionada.cerrar(observacionCierre, motivoSeleccionado, comentarioIngresado, hora, fecha);
    ...
    public Empleado buscarEmpleadoRI() {
        // Simular empleado logueado (en una aplicación real vendría de la sesión)
        return baseDatosEmpleados.get(0); // Juan Pérez
    }
